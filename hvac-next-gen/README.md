...
hvac-next-gen/
  ...
  trainers/
    unified-master/
      firmware/             # Unified PlatformIO project for both trainer targets
  platform/
...
The active hardware workflow uses a single unified firmware project for both trainer profiles:
...
Target profile selection is handled at flash time by the unified flash scripts and board identity strap.
